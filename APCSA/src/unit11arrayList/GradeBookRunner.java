...
public class GradeBookRunner
{
   public static void main( String args[] )
   {
		...
		out.println(ipC.getFailureList(70));
		out.println("Highest average = "+ipC.getStudentWithHighestAverage());
		out.println("Lowest average = "+ipC.getStudentWithLowestAverage());
